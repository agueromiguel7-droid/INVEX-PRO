...
TRANSLATIONS = {
    ...
    # Labels and Section Headers for Project Details
    "Información Detallada del Proyecto": "Detailed Project Information",
    "A. IDENTIFICACIÓN GENERAL": "A. GENERAL IDENTIFICATION",
    "B. DESCRIPCIÓN EJECUTIVA DE LA OPORTUNIDAD": "B. EXECUTIVE DESCRIPTION OF THE OPPORTUNITY",
    "C. CARACTERÍSTICAS DE LA INVERSIÓN": "C. INVESTMENT CHARACTERISTICS",
    "D. INDICADORES FINANCIEROS (Rangos Esperados)": "D. FINANCIAL INDICATORS (Expected Ranges)",
    "E. ESTUDIO DE MERCADO": "E. MARKET STUDY",
    "F. PROBABILIDAD Y FIRMEZA DE LA OPORTUNIDAD": "F. PROBABILITY AND FIRMNESS OF THE OPPORTUNITY",
    "G. ANÁLISIS DE RIESGO": "G. RISK ANALYSIS",
    "H. ENTORNO Y SERVICIOS CONEXOS": "H. ENVIRONMENT AND RELATED SERVICES",
    "I. CONCLUSIÓN Y RECOMENDACIÓN": "I. CONCLUSION AND RECOMMENDATION",
    "J. DATOS DEL CONTACTO PRINCIPAL": "J. PRIMARY CONTACT DATA",
    
    # Financial Overview Labels
    "Financial Overview": "Financial Overview",
    "PAYBACK PERIOD": "PAYBACK PERIOD",
    "USD NET VALUE": "USD NET VALUE",
    "RISK ANALYSIS": "RISK ANALYSIS",
    "Risk Profile Index": "Risk Profile Index",
    "Principales riesgos identificados:": "Main identified risks:",
    "Técnico:": "Technical:",
    ...
    # Field Specific Labels (Excel Columns)
    "Resumen": "Summary",
    "Describir Otros": "Describe Others",
    "Alcance del proyecto": "Project Scope",
    "Ventaja competitiva principal": "Main Competitive Advantage",
    "Estado actual de madurez": "Current Maturity State",
    "Monto de inversión estimado (MMUSD)": "Estimated Investment Amount (MMUSD)",
    "Tipo de inversión": "Investment Type",
    "Clase de estimación": "Estimation Class",
    "Clase de estimación (Si es proyecto nuevo)": "Estimation Class (if new project)",
    "% Participación inversionista": "% Investor Participation",
    "% Participación socios actuales": "% Current Partners Participation",
    "Tipo de acuerdo": "Agreement Type",
    "Tipo de acuerdo(si aplica)": "Agreement Type (if applicable)",
    "¿Compra total o parcial?": "Total or Partial Purchase?",
    "% de adquisición": "% Acquisition",
    "TIR (%)": "IRR (%)",
    "VPN (MMUSD)": "NPV (MMUSD)",
    "Tiempo de recuperación (años)": "Payback period (years)",
    "Vida útil estimada del proyecto": "Estimated Project Life",
    "Sensibilidad (escenarios)": "Sensitivity (scenarios)",
    "Precio base (MMUSD)": "Base Price (MMUSD)",
    "Volumen proyectado": "Projected Volume",
    "CAPEX (MMUSD)": "CAPEX (MMUSD)",
    "OPEX (MMUSD)": "OPEX (MMUSD)",
    "Tasa de descuento utilizada": "Discount Rate Used",
    "Demanda identificada": "Identified Demand",
    "Segmento objetivo": "Target Segment",
    "Competencia relevante": "Relevant Competition",
    "Barreras de entrada": "Entry Barriers",
    "Ventana de oportunidad (timing)": "Opportunity Window (timing)",
    "Conclusión del estudio de mercado": "Market Study Conclusion",
    "Probabilidad estimada de concreción (%)": "Estimated Probability (%)",
    "Nivel de firmeza": "Firmness Level",
    "Factores críticos para cierre": "Critical Closing Factors",
    "Dependencias externas": "External Dependencies",
    "Riesgo Técnico": "Technical Risk",
    "Mitigaciones Riesgo Técnico": "Technical Risk Mitigation",
    "Riesgo Financiero": "Financial Risk",
    "Mitigaciones Riesgo Financiero": "Financial Risk Mitigation",
    "Riesgo Regulatorio": "Regulatory Risk",
    "Mitigación Riesgo Regulatorio": "Regulatory Risk Mitigation",
    "Riesgo Mercado": "Market Risk",
    "Mitigación Riesgo Mercado": "Market Risk Mitigation",
    "Servicio Energía Estimado (USD)": "Est. Energy Service (USD)",
    "Servicio Agua Estimado (USD)": "Est. Water Service (USD)",
    "Servicio Gas Estimado (USD)": "Est. Gas Service (USD)",
    "Costo de vida en la zona": "Cost of Living in the Area",
    "Acceso a educación": "Access to Education",
    "Infraestructura logística": "Logistics Infrastructure",
    "Disponibilidad de talento humano": "Human Talent Availability",
    "Evaluación integral": "Comprehensive Evaluation",
    "Recomendación": "Recommendation",
    "Próximos pasos": "Next Steps",
    "Fecha estimada de decisión final": "Est. Final Decision Date",
